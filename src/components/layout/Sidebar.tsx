import { Link, useLocation } from "wouter";
  ...
  import {
    ...
    BarChart2, Calendar, Zap, Archive, UserCheck, FileCode
  } from "lucide-react";
  ...
  const NAVIGATION = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: "/fsutil", label: "FSUTIL e COMPACT", icon: HardDrive },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { path: "/privilegios", label: "TAKEOWN e RUNAS", icon: UserCheck },
        ...
        { path: "/energia", label: "Gerenciamento de Energia", icon: Zap },
      ]
    },
    {
      title: "Rede",
    ...
    },
    {
      ...
      items: [
        ...
        { path: "/backup-vss", label: "Backup e Shadow Copies", icon: Archive },
      ]
    },
    {
      title: "Segurança",
      items: [
        ...
        { path: "/bitlocker", label: "BitLocker e Criptografia", icon: Lock },
        { path: "/auditoria-seguranca", label: "Auditoria e AUDITPOL", icon: Shield },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { path: "/instalacao-silenciosa", label: "Instalação Silenciosa", icon: FileCode },
      ]
    },
    {
