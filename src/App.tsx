import { useState, useEffect } from "react";
  ...
  import Fsutil from "@/pages/Fsutil";
    ...
    return (
      <Layout>
        <Switch>
          ...
          <Route path="/backup-vss" component={Backup} />
          <Route path="/bitlocker" component={BitLocker} />
          <Route path="/energia" component={Energia} />
          <Route path="/fsutil" component={Fsutil} />
          <Route path="/auditoria-seguranca" component={Auditoria} />
          <Route path="/privilegios" component={Privilegios} />
          <Route path="/instalacao-silenciosa" component={Instalacao} />
